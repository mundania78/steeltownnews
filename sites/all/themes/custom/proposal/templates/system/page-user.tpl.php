...
?>
  ...
  <footer>
    <div class="container-fluid inner">
      <div class="row-fluid">
        <div class="span12">
          <p><strong>Phipps Conservatory Website &amp; Ecommerce Proposal</strong><br />
            Copyright 2013 Viable Industries, L.L.C., All rights reserved.</p>
            <p>We are located at 6101 Penn Ave, Suite 201 in Pittburgh, Pennsylvania. Our offices are on the second floor of the Liberty Bank Building in The Beauty Shoppe's innovative working space. You can <a href="www.viable.io" target="_blank">visit our website at www.viable.io</a></p>
          <p>The code, ideas, concepts, and other intellectual property presented on this page are considered proprietary information, except where otherwise noted, and should not be shared with other organizations, companies, or individuals.</p>
          <p>The text, images, and other content of this page is the property of Viable Industries, L.L.C., unless where otherwise noted.</p>
        </div>
      </div>
    </div>
  </footer>
